...
//        System.out.println("Confira se o conjunto 3 está vazio: " + notas3.isEmpty());
        ...
        Set<Serie> minhasSeries = new HashSet<>(){{
            add(new Serie("Anéis do poder", "Fantasia", 60));
            add(new Serie("House Of Dragons", "Fantasia", 60));
            add(new Serie("Roda do Tempo", "Fantasia", 60));
        }};
        ...
        Set<Serie> minhasSeries1 = new LinkedHashSet<>(){{
            add(new Serie("Anéis do poder", "Fantasia", 50));
            add(new Serie("House Of Dragons", "Fantasia", 40));
            add(new Serie("Roda do Tempo", "Fantasia", 60));
        }};
